...
def float_division(a, b)
 a.to_f / b.to_f # return the result of dividing a by b as a float, rather than an integer
end

def string_to_number(string)
  string.to_i  # return the result of converting a string into an integer
end
